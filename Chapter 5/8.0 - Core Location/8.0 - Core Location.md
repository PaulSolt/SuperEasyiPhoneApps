...
1. Delete the app and test different configurations (Yes, No)

3. Test revoking access using the settings app

4. Test changing locations over time (disable weather requests to limit APIs)

5. You can set the location for testing using Xcode, Simulator, or on an Xcode Scheme

6. Make sure you restore the original app settings so that you don't get rate limited or run out of API requests!