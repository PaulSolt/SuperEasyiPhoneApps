...
Drag an outlet connection from the *Hello!* `UILabel` to the ViewController.swift code file in the Assistant Editor. Type the name *helloLabel* and Xcode will auto-insert the code:
	...
	@IBOtlet weak var helloLabel: UILabel!
...
Make sure you write down anything that seems strange or new to you.
# 1.  Programmatically Change a UILabel (Without Auto Layout) #

In your buttonPressed

# 2. Add Auto Layout to Your Storyboard UI #

# 2. String? #

An optional string, which means it may or may not have a value.
