...
* Paul's Notebook: [Squared Extra-large Moleskine](Amazon LINK)
* Paul's Pens: [Staedtler Pigment Liner 0.3](Amazon LINK)
* Paul's Quick Notes: [Post-it Notes](Amazon LINK)
* [Super Easy Apps Community Forum](http://community.SuperEasyApps.com) 
...
## Links ##
1. [Email best practices](EMAIL LINK)
2. [How to write effective emails](EMAIL LINK)
...
PS I respond quicker to short emails. =)
...
1. [Discourse Guide](DISCOURSE LINK)
2. [Discourse Tutorial](DISCOURSE LINK)
...
1. Normally the chunk of code is indented four spaces
2. In a list the chunk of code must be indented eight spaces
...
1. Indent your code properly
	...
	3. Indent Left: <kbd>Command</kbd> + <kbd>[</kbd>
...
# 5.3.5 Homework - Take and Share iPhone App Screenshots on Discourse #
...
###Take a Screenshot of the Simulator on Mac
...
# 5.3.4 Homework - Share a Video Using Quicktime and YouTube #
