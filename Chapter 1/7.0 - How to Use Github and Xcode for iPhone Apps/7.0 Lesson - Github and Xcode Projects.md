...
## 7.9 Bug Fix - How to Resolve Conflicts With Storyboard Files and Code ##
...
2. Storyboard files must be opened as a code file to resolve conflicts
	...
	2. Open As
	3. Source Code
3. Remove the conflicts between the markers >>>>>>> HEAD ====== <<<<<< Master
...
## 7.10 More Advanced Git and Github Resources ##
...
Bigger Teams: Clean revision history
